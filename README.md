...
## References
sql-common-reserved-words  <br> 
https://www.ibm.com/docs/en/netezza?topic=srwk-sql-common-reserved-words  <br> 
sql-non-reserved-keywords  <br> 
https://www.ibm.com/docs/en/netezza?topic=srwk-non-reserved-keywords <br> 
<br> <br> 
<br> 
# Source of Truth
## Category
...
## Category
## Description
It is important to design the Individual’s name carefully.  <br> 
...
Secondly, consider all possible applicable conditions to the names for the county or countries and the cultural background. <br> 
These are some of the fields to be considered when designing Individuals' names: <br> 
. First Given Name <br> 
. Middle Name<br> 
. Preferred Name <br> 
. Given Name  <br> 
...
# Individual – Diversity - Equity - Inclusion
## Category
## Description
Other fields may be applicable when collecting Individual data.<br> 
. Nationality. <br> 
. Gender Identification. <br> 
. Pronouns.<br> 
. Veteran status.<br> 
. Ethnic minorities (e.g., Aboriginal identification).   <br> 
...
Firstly, it is important to avoid storing Addresses in a single field.  <br>
Secondly, consider that a person may have several addresses, which they can change at will.   <br>
One person may use several addresses (home, work, previous, holiday etc.), and each address is likely to be associated with different sets of people, such as family members, friends or colleagues.   <br>
The order in which names and addresses are written varies between countries.   <br>
An address is a label referencing a geographical object, such as a property, using identifiable real-world objects.4 Postal address is used for the delivery of mail.   <br>
It is primarily a routing instruction leading to the property. However, most geographic objects have addresses, some postal addresses, but some never receive mail.<br>
These include:  <br>
. Domestic, commercial and industrial properties.  <br>
. Public buildings (schools, hospitals, prisons, halls, leisure facilities, public toilets).  <br>
. Churches and monuments.  <br>
. Places where events take place (sports fields, parks, mountains and lakes).  <br>
  <br>
Addresses normally have a structure using a nested set of spatial units:  <br>
. Country.  <br>
. One or more geographic areas (locality, town, county etc.)  <br>
